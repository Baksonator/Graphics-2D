...
public class ImageCollector {
	...
	public ImageCollector() {
		...
		guitarObject = ImageGenerator.scaleImageJava(Util.loadImage("objects/guitar_red.jpg"), 100, 100);
		snakeObject = ImageGenerator.scaleImageJava(Util.loadImage("objects/snake.jpg"), 100, 100);
